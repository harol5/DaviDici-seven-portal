                ...
                {!isLoading && (
                    <div>
                        <h1 className="font-semibold">
                            Order number: {nextOrderNumber} was automatically
                            generated. You can change this number but keep in
                            mind:
                        </h1>
                        <ul className="my-2">
                            <li>
                                1 - order number cannot be longer than 6 digits.
                            </li>
                            <li>
                                2 - make sure you dont use a number previously
                                assign to other orders.
                            </li>
                        </ul>
